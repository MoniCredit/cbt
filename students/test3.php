                ...
                <div class="navbar-header2 navbar-header">
                    <div class="titleprofilebar" style=""> 
                        <div class="user-info-profile-image2 passport">
                            <?php
                                if (isset($_SESSION['image']) && !is_null($_SESSION['image'])) {
                                    echo '<img id="passport" src="../_files/_passport/' . $_SESSION['image'] . '"
                                    alt="" width="140" height="140" />';
                                } else {
                                    echo '<img id="passport" src="../_res/img/passport/default.jpg"
                                    alt="" width="140" height="140" />';
                                }
                            ?>
                                                            ...
                                                            <div class="tab-content">
                                                                ...
                                                                if (($finish == 0) && ($be_default == 1)) {
                                                                    ...
                                                                    while ($rowque = mysqli_fetch_array($dataque)) {
                                                                        ...
                                                                        <div role="t1" class="tab-pane <?= $a; ?> fade in" id="<?= 'ts'.$counter; ?>">  
                                                                            <div class="table">
                                                                                <table class="table table-striped">
                                                                                    <thead>
                                                                                        <tr>
                                                                                            <th>Question <?php echo $n; ?> 
                                                                                                <a href="#<?= 'ts'.($counter+1); ?>" data-toggle="tab"><button type="button" class="btn btn-primary next">Next</button></a>
                                                                                                <a href="#<?= 'ts'.($counter-1); ?>" data-toggle="tab"><button type="button" class="btn btn-info next">Previous</button></a>                                                                                 
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                             ...
                                                                                             echo  ' A. <input type="radio" id="ts1'.$testidats.'q'.$ucid.'" name="choice" data-value="ts'.$testidats.'q'.$ucid.'" '.$ch1.' value="1"> 
                                                                                                    ...
                                                                                                    <input type="hidden" value="<?= 'ts'.($counter+1); ?>" name="nextq">
                                                        ...
                                                        if (isset($ucid)) {
                                                            foreach ($ucids as $ucid) {
                                                                ...
                                                                if (empty($answer) || empty($ucid)) {
                                                                    echo '<a href="#ts'.$counter2.'" data-toggle="tab"><button id="pts' . $testidats . 'q' . $ucid . '" type="button" class="btn btn-default btnpg">' . $nq . '</button></a>';
                                                                } else {
                                                                    echo '<a href="#ts'.$counter2.'" data-toggle="tab"><button id="pts' . $testidats . 'q' . $ucid . '" type="button" class="btn btn-primary btnpg">' . $nq . '</button></a>';
                                                                }
                                                                $nq++;
                                                            }
                                                        }
