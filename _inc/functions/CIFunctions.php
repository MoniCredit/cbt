...
if(!isset($_SESSION)){
 ...
 function url(){
  ...
  // if using valet comment this but use it if you're using xampp
	// return $url = $home_url = 'http://' . $_SERVER['HTTP_HOST'] . '/cbt' . $appfolder;
	  // if using valet uncomment this
...
function printHeader(){
	 echo '	<div class="logo">
                    ...
                    <h2>Tai Solarin University of Education Secondary School</h2>
                    <h4> RWHM+J26, Igbeba Rd, Ijebu ode 120101, Ogun State</h4>
                 </div>';
}
