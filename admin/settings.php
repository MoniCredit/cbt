    ...
    //  print_r($active_cols); die();
     ...
     foreach ($active_cols as $col) {
        ...
        if($col == 'all'){
            ...
            // $coll =  "2___".$col."_____%";
            $sql = "UPDATE  `users` SET sch = '1' WHERE college LIKE '$col'";
            mysqli_query($dbc, $sql );
        }
                                        ...
                                        <form role="form">                                                                                        
                                            ...
                                            <div class="logo3">
                                                <img id="passport" src="../_res/img/passport/<?php echo $userid; ?>.jpg" 
                                                     alt="" width="120" height="120" src = '../_res/img/logo3.jpg' />
                                            </div>                                            
                                            <div class="form-group">
                                     ...
                                     <div class="col-lg-6">
                                        <form role="form" method="POST">                                                                                        
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label class="radio-inline">
                                                    <input type="checkbox" name="active_col[]" value="COSPED" /> COSPED
                                                </label>
                                                <label class="radio-inline">
                                                    <input type="checkbox" name="active_col[]" value="COSIT" /> COSIT 
                                                </label>
                                                 <label class="radio-inline">
                                                    <input type="checkbox" name="active_col[]" value="COHUM" /> COHUM
                                                </label>
                                                 <label class="radio-inline">
                                                    <input type="checkbox" name="active_col[]" value="COSMAS" /> COSMAS
                                                </label>
                                                 <label class="radio-inline">
                                                    <input type="checkbox" name="active_col[]" value="COVTED" /> COVTED
                                                </label>
                                                <label class="radio-inline">
