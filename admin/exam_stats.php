                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <?php 
                                            ...
                                            @$pass_percent = $assessed?round(($passno/$assessed * 100), 2): 0;
                                             @$pass_percent10 = $assessed?round(($passno/$assessed * 10), 2): 0;
                                            @$failed_percent = $assessed?round(($failedno/$assessed * 100), 2):0;
