    ...
    if( isset($_POST['upload_user'])){ //database query to upload Admitted Student		
    	...
    	if(is_uploaded_file($_FILES['filename']['tmp_name'])){
    		...
    		while (($data = fgetcsv($handle, 1500, ",")) !== FALSE) {
                        ...
                        $prep_query = sprintf("INSERT INTO users (id, userid, fname, mname, lname, sesid, password, college) "
                    ...
                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form role="form" method="post" action="/admin/students.php" name="add_user">
                                    ...
                                    <div class="modal-body">
                                        <div class="well">
                                            ...
                                            <table class="table table-bordered table-condensed table-responsive">
                                                ...
                                                <tbody>
                                                userid, fname, mname, lname, sesid, password, college
                                                    <tr>
                                                        <td>20090204001</td>
                                                        <td>Ogbeni</td>
                                                        <td>Adamu</td>
