                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $tests['highscore']? round($tests['highscore'],2): 0; ?>% </td>                                                
                                        <td><?php echo $tests['avg_score']? round($tests['avg_score'],2): 0; ?>% </td>                                                
                                        <td><?php echo $tests['lowscore']? round($tests['lowscore'],2): 0; ?>% </td>                                                
                                        <td><?php echo $tests['avg_time']? round($tests['avg_time'],2): 0; ?></td>
                                        <td>  
